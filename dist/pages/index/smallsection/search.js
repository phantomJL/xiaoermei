...
var Search = function (_BaseComponent) {
  ...
  function Search() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Search.__proto__ || Object.getPrototypeOf(Search)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["selector", "selectorChecked", "city", "changehousecity", "dispatch"], _this.onChange = function (e) {
      _this.setState({
  ...
  _createClass(Search, [{
    ...
    key: "HouseDetail",
    value: function HouseDetail(city) {
      console.log(city);
    ...
    key: "ParturitionDetail",
    value: function ParturitionDetail(city) {
...
Search.$$events = ["onChange", "HouseDetail", "ParturitionDetail"];
